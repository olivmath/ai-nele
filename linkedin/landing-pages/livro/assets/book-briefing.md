...
| **Ano**       | 2026                                             |
| **Formato**   | Livro fisico impresso (capa dura)                |
...
## Jornada do Leitor (3 partes)

### Parte I: Dominando Solidity (Cap 0-16)
Do zero ao dominio completo da linguagem: blockchain, Ethereum, EVM, variaveis, tipos, expressoes, controle de fluxo, funcoes, armazenamento, erros, modificadores, eventos, heranca, libraries, contratos e ERC20.

### Parte II: Pratica e Seguranca (Cap 17-18)
...
### Parte III: Projeto: Construa, Hackeie e Proteja (Cap 19-24)
Ciclo completo de um protocolo DeFi em miniatura, cada capitulo com acao explicita:
1. **Especifique** (Cap 19): regras de negocio, tokenomics com curva de preco matematica, threat model
2. **Construa** (Cap 20): Token ERC20 (Solady) + VendorMachine (PRB Math, bonding curve)
3. **Teste** (Cap 21): suite completa com Foundry (unit, fuzz, invariante)
4. **Hackeie** (Cap 22): Slither + exploracao manual de 3 bugs plantados (atacante e defensor)
5. **Proteja e Publique** (Cap 23): correcao de vulnerabilidades + deploy em Sepolia e Base Sepolia
6. **Evolua** (Cap 24): EVM internals, proxies, ZKP, account abstraction, DeFi, oraculos
...
- **Livro fisico de verdade**: edicao limitada, capa dura, 50 exemplares
- **Comunidade + lives mensais**: convite para comunidade exclusiva do livro com lives mensais
...
### Cap 19 - Especifique: Definicao do Projeto
...
### Cap 20 - Construa: Desenvolvimento dos Contratos
...
### Cap 21 - Teste: Teste dos Contratos
...
### Cap 22 - Hackeie: Auditoria dos Contratos
...
### Cap 23 - Proteja e Publique: Deploy dos Contratos
...
### Cap 24 - Evolua: Proximos Passos e Topicos Avancados
