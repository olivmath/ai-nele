...
Check if `.agents/[brand-context.md](http://brand-context.md)` already exists (or `.claude/[brand-context.md](http://brand-context.md)`). If it does, read it and ask the user what they'd like to update. If it doesn't exist, collect the information below.
...
Once you have the information, create a file at `.agents/[brand-context.md](http://brand-context.md)` with this structure:
